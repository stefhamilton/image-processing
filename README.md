# Get a credentials.json file
In google console I am using project process-images stefan@whiteboxllms.com. Place in root folder.
...
# How To Run
1. Get credentials_google_admin
2. 